...
class _EditCarScreenState extends ConsumerState<EditCarScreen> {
  ...
  void initState() {
    ...
    _hasTint      = c.hasTint;
    _tintDate     = c.tintDate;
    _photoPath    = c.photoUrl;
  }
  ...
  Future<void> _pickPhoto(ImageSource source) async {
    ...
    if (path != null) {
      if (_photoPath != null && _photoPath != widget.car.photoUrl) {
        await PhotoHelper.delete(_photoPath);
      }
  ...
  InputDecoration _dec(String label,
      {IconData? icon, bool isDark = true, String? suffix}) {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          style: _inputStyle(isDark),
                          decoration: _dec(l10n.carModel, isDark: isDark),
                          validator: (v) => v?.trim().isEmpty == true
                              ? l10n.requiredField
                              : null,
                        ),
...
class _EditAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const _EditAppBar({required this.car, required this.l10n});
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isDark
              ? [const Color(0xFF0A2444), const Color(0xFF111827)]
