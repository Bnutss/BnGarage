class AppStrings {
  static const _data = <String, Map<String, String>>{
    'ru': {
      ...
      'car_add_record':         'Добавить запись',
      ...
      'service_add_first':     'Нажмите + чтобы добавить первую\nзапись обслуживания',
      ...
      'record_interval_hint': 'Укажите интервал для автоматического напоминания',
      ...
      'reminders_empty':     'Нет просроченных или предстоящих\nзамен и обслуживаний',
    ...
    'en': {
      ...
      'onb_reminders_desc': 'Never miss a service — alerts\nby mileage and by date',
